...
public class MyArrayListWithSort<T extends Comparable<T>> extends MyAbstractDynamicArray<T> implements MyList<T> {

    public MyArrayListWithSort() {
        super();
    }

    public MyArrayListWithSort(int initialSize) {
        super(initialSize);
    }
